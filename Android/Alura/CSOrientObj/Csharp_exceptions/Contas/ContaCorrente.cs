...
namespace Csharp_exception
{
    public class ContaCorrente
    {
        ...
        public bool Sacar(double valor)
        {
            ...
            {
                //throw new IndexOutOfRangeException("Saldo insuficiente.");
        ...
        public ContaCorrente(int numero_agencia, string numero_conta)
        {
            ...
            if (numero_agencia <= 0)
            {
                throw new ArgumentException("\nO número de agência menor ou igual a zero!", nameof(numero_agencia));
            }
            ...
            {
                Console.WriteLine("\nOcorreu um erro! Não é possível fazer uma divisão por zero!");
            }          
            */
